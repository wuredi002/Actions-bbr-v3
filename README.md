...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/wuredi002/Actions-bbr-v3/main/install.sh)
```
...
curl -fsSL -o cve_2026_31431_detector.py https://raw.githubusercontent.com/wuredi002/Actions-bbr-v3/main/cve_2026_31431_detector.py
